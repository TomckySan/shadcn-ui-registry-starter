...
const OSAccordionItem = React.forwardRef<
...
OSAccordionItem.displayName = "OSAccordionItem";

const OSAccordionTrigger = React.forwardRef<
...
OSAccordionTrigger.displayName = "OSAccordionTrigger";

const OSAccordionContent = React.forwardRef<
...
OSAccordionContent.displayName = "OSAccordionContent";
